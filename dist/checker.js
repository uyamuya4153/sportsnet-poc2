...
async function checkTarget(page, target, screenshotDir) {
    ...
    try {
        ...
        // デバッグ用にスクリーンショットを保存
        await (0, scraper_1.takeScreenshot)(page, './screenshots/debug_page.png');
        ...
        const matchingRooms = availabilityData.filter(room => room.roomName.includes(target.room) || target.room.includes(room.roomName));
